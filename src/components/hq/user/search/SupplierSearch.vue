<template>
  <div class="supplier-user-search">
    <!-- 검색 영역 -->
      ...
      <div class="search-results-list">
        ...
        >
          ...
          <div class="user-info">
            ...
            <div class="user-details">{{ user.supplierName }}</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div v-if="selectedUser" class="user-detail-section">
      ...
      <div class="detail-content">
        ...
        <!-- 공급처 정보 -->
        <div class="info-section">
          <h5 class="section-title">공급처 정보</h5>
          <div class="detail-grid">
            <div class="detail-item">
              <label>공급처 코드</label>
              <span>{{ selectedUser.supplierCode }}</span>
            </div>
            <div class="detail-item">
              <label>공급처명</label>
              <span>{{ selectedUser.supplierName }}</span>
            </div>
            <div class="detail-item">
              <label>대표자명</label>
              <span>{{ selectedUser.supplierCeoName }}</span>
            </div>
            <div class="detail-item">
              <label>사업자번호</label>
              <span>{{ selectedUser.supplierBusinessNumber }}</span>
            </div>
            <div class="detail-item">
              <label>회사 전화번호</label>
              <span>{{ selectedUser.supplierCompanyPhone }}</span>
            </div>
            <div class="detail-item full-width">
              <label>주소</label>
              <span>
                {{ selectedUser.supplierAddress }}
                ({{ selectedUser.supplierZipcode }})
              </span>
            </div>
            <div class="detail-item">
              <label>계약일</label>
              <span>{{ formatDate(selectedUser.supplierSignedAt) }}</span>
            </div>
          </div>
        </div>
      </div>
...
const searchUsers = async () => {
  ...
  try {
    ...
    const response = await api.get("/api/hq/user/supplier", { params });
