<template>
  <div class="franchise-user-register">
      ...
      <form @submit.prevent="handleSubmit" class="register-form">
        ...
        <div class="form-section">
          ...
          <div class="form-grid">
            ...
            <!-- 나머지 폼 필드들 -->
            <div class="form-group">
              <label for="franchiseName" class="form-label">가맹점명 <span class="required">*</span></label>
              <input
                id="franchiseName"
            ...
            <div class="form-group">
              <label for="franchisePhone" class="form-label">가맹점 전화번호 <span class="required">*</span></label>
              <input
                id="franchisePhone"
                v-model="formData.franchisePhone"
                type="tel"
                class="form-input"
            ...
            <div class="form-group full-width">
              <label for="address" class="form-label">주소 <span class="required">*</span>
              </label>
              <input
                id="address"
        ...
        <div class="form-actions">
          ...
          <button
            ...
            :disabled="isLoading || !selectedManager || addressError != ''"
          >
    ...
    <!-- Search Results Portal - Moved outside form to avoid clipping -->
    <Teleport to="body">
      <div 
...
const validateAddress = () => {
  ...
  if (!address) {
    ...
    // 서울의 구가 포함되어 있는지 확인
    const hasValidDistrict = seoulDistricts.some(district => address.includes(district))
    
    if (!hasValidDistrict) {
      addressError.value = '유효한 서울의 구가 없습니다.'
    } else {
      addressError.value = ''
    }
...
const selectManager = (manager) => {
  ...
  formData.departmentId = manager.departmentId
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const submitData = {
      ...
      franchisePhone: formData.franchisePhone,
