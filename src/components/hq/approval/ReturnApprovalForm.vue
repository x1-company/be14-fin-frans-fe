<template>
  <div class="return-approval-form">
    <!-- 반품 문서 선택 -->
    <div class="form-section">
      <h3 class="section-title">반품 문서 선택</h3>
    ...
    <!-- 반품 사유 -->
    <div class="form-section">
      <h3 class="section-title">반품 사유</h3>
      <div class="return-reason-form">
        <div class="form-group">
          <label>반품 사유</label>
          <select v-model="formData.returnReason" class="reason-select">
            <option value="">반품 사유를 선택하세요</option>
            <option value="DEFECTIVE">불량품</option>
...
const documents = ref([
  ...
  { id: 2, name: "KFC 불량품 반품", date: "2025.05.29", amount: 89000 },
]);
