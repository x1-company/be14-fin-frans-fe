      ...
      <div class="modal-content">
        ...
        <div v-else-if="userInfo" class="user-info-container">
          ...
          <div class="info-grid">
            ...
            <!-- 조직 정보 -->
            <div class="info-section">
              <h4 class="section-title">조직 정보</h4>
              <div class="info-item">
              ...
              <div class="info-item">
                ...
                <span class="info-value">{{ userInfo.dutyName }}</span>
              </div>
              <div class="info-item">
                <Award class="w-4 h-4 text-gray-500" />
                <span class="info-label">직급</span>
                <span class="info-value">{{ userInfo.positionName }}</span>
              </div>
            </div>
          </div>
        </div>
...
import { X, User, Phone, Mail, Building, Briefcase, Award, AlertCircle } from 'lucide-vue-next'
...
const fetchUserInfo = async () => {
  try {
    ...
    const response = await api.get('/api/hq/user/me')
